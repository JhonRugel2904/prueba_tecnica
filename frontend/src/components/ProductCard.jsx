...
const ProductCard = ({ product }) => {
    ...
    console.log("Datos del producto al hacer clic:", product);
    try {
        await addToCart(product);
      Swal.fire({
        title: '¡Agregado!',
        text: `${product.title} se añadió a tu carrito.`,
        icon: 'success',
        timer: 1500, 
      ...
      <div className="p-5 flex flex-col flex-grow">
        ...
        <div className="mt-auto pt-4 flex items-end justify-between">
          ...
          <button 
            ...
            className="bg-slate-900 hover:bg-indigo-600 text-white p-3 rounded-xl transition-colors shadow-sm flex items-center justify-center cursor-pointer"
          >
